                ...
                <div className="container-x mx-auto">
                  <ul className="flex space-x-12 ">
                    <li>
                      <span
                        onClick={() => setTab("des")}
                        className={`py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer relative z-10 ${tab === "des"
                    ...
                    <li>
                      <span
                        ...
                        className={`py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer relative z-10 ${tab === "review"
                            ? "border-qgreen text-qblack "
                            : "border-transparent text-qgray"
                          }`}
                      >
                    ...
                    {Multivendor() === 1 && details.is_seller_product && (
                      <li>
                        <span
                          onClick={() => setTab("info")}
                          className={`py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer relative z-10 ${tab === "info"
                              ? "border-qgreen text-qblack "
                              : "border-transparent text-qgray"
                            }`}
                        >
                ...
                <div className="inputs w-full">
                  ...
                  <div className="w-full mb-[40px]">
                    ...
                    <textarea
                      ...
                      cols="30"
                      rows="6"
                      className={`w-full focus:ring-0 rounded focus:outline-none py-3 px-4 border  placeholder:text-sm text-sm ${reportErrors ? "border-qred" : "border-[#CBECD9]"
                        }`}
