      ...
      >
        ...
        >
          <div className="w-full">
            <div className="w-full md:h-[600px] h-[350px] border border-[#df3a4b] flex justify-center items-center overflow-hidden relative mb-3 relative rounded">
              <Image
                layout="fill"
              ...
              />
              {product.offer_price && (
                <div className="w-[40px] h-[40px] rounded-full bg-qred text-qblack flex justify-center items-center text-sm font-medium absolute left-[30px] top-[30px]">
            ...
            <div className="flex gap-2 flex-wrap">
              <div
                ...
                className="w-[110px] h-[110px] p-[15px] border border-[#df3a4b] cursor-pointer relative rounded"
              >
                <Image
                  layout="fill"
                  objectFit="scale-down"
        ...
        <div className="flex-1">
          <div className="product-details w-full mt-10 lg:mt-0">
            ...
            <div className="w-full h-[1px] bg-[#df3a4b] mb-[30px]"></div>
            {/* <div className="p-3 bg-qgreenlow flex items-center space-x-2 mb-[30px] rounded-lg w-fit">
              ...
              <span className="text-base font-bold text-qred">
                {product.qty !== "0"
            ...
            >
              ...
              <div className="flex-1 h-full">
                <button
                  onClick={addToCard}
                  type="button"
                  className="bg-qred text-white rounded-md text-sm font-semibold w-full h-full"
                >
            ...
            <div data-aos="fade-up" className="mb-[20px]">
              <p className="text-[13px] text-qred leading-7">
