...
export default function Footer({ settings, contact }) {
  ...
  return (
    <footer className="footer-section-wrapper  print:hidden bg-light -mt-[30px] pl-3.5 sm:pl-0">
          ...
          <div className="flex-1 lg:flex  ml-0 w-full mb-10 lg:mb-0">
                ...
                <Link href="/" passHref>
                  <a>
                    {settings && (
                      ...
                      //alt="logo"
                      ///>
                      <h2 className="text-bolder">Ration Bazzar</h2>
                    )}
                  </a>
                </Link>
              </div>
                        ...
                        <li key={i}>
                          <Link href={item.link} passHref>
                            <a rel="noopener noreferrer">
                              <span className="text-red text-[15px] hover:text-qred hover:underline cursor-pointer">
                                {item.title}
                              </span>
                            </a>
                          </Link>
            ...
            <div className="lg:w-[260px] w-full mb-10 lg:mb-0 mt-10 lg:mt-0">
              {firstCol && (
                <>
                  <div className="mb-5">
                    <h6 className="text-[18] font-500 text-black">
            ...
            <div className="lg:w-[260px] lg:flex lg:flex-col w-full mb-10 lg:mb-0 relative">
              ...
              <div className="w-[1px] xl:block hidden h-[270px] absolute left-[213px] bg-red"></div>
            </div>
          </div>
                ...
                <div>
                  <div className="w-full flex space-x-5 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-[15px] text-red leading-[30px] w-[248px]">
                        {contact.address}
                      </p>
                    </div>
                  </div>
