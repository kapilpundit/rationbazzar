    ...
    <>
      <div className="order-tracking-wrapper w-full">
        <div className="container-x mx-auto">
          ...
          />
          {resData && (
            <div className="w-full h-[168px]  bg-danger rounded-2xl mb-10 relative print:hidden">
              ...
              <div className="flex lg:space-x-[373px] space-x-[90px] w-full h-full justify-center">
                <div className="relative">
                  <div className="w-[30px] h-[30px] border-[8px] rounded-full border-qred bg-white relative z-20"></div>
