              ...
              {datas.contact && (
                <div>
                  ...
                  <div className="xl:flex xl:space-x-[30px] mb-[30px]">
                    <div className="xl:w-1/2 w-full rounded  h-[196px] flex flex-col item justify-center bg-white border border-qred p-5">
                      <div className="flex justify-center mb-3 ">
                        ...
                        >
                          <circle cx="22" cy="22" r="21.5" stroke="#df3a4b" />
                          <path
              ...
              <div className="inputs mt-5">
                ...
                <div className="mb-5">
                  ...
                  <textarea
                    ...
                    className={` w-full h-[105px] focus:ring-0 rounded focus:outline-none p-6 border placeholder:text-sm ${!!(errors && Object.hasOwn(errors, "message"))
                      ? "border-qred"
                      : "border-[#CBECD9]"
                      }`}
                  ></textarea>
