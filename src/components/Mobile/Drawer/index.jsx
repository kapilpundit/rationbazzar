  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`w-[280px] transition-all duration-300 ease-in-out h-screen overflow-y-auto overflow-x-hidden overflow-style-none bg-white fixed left-50 top-0 z-50 ${open ? "left-0" : "-left-[280px]"
            }`}
        >
            ...
            <div className="flex justify-between items-center">
              <div className="flex space-x-5 items-center">
                <div className="compaire relative">
                  ...
                  <span className="w-[18px] h-[18px] rounded-full bg-[#DE4839] text-white absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px]">
          ...
          <div className="w-full mt-5 px-5">
            <div className="search-bar w-full h-[34px]  flex ">
              ...
              <div
                ...
                className="cursor-pointer w-[40px] h-full bg-[#DE4839] flex justify-center items-center"
              >
                ...
                {categoryList &&
                  categoryList.slice(0, 10).map((item, i) => (
                    <li key={i} className="category-item">
                      ...
                      >
                        <div className=" flex justify-between items-center px-5 h-12 bg-white hover:bg-[#DE4839] transition-all duration-300 ease-in-out cursor-pointer">
                  ...
                  <ul className="submenu-list ml-5">
                    <li className="category-item">
                      <Link href="/privacy-policy">
                        <div className=" flex justify-between items-center px-5 h-12 bg-white hover:bg-qred transition-all duration-300 ease-in-out cursor-pointer">
                          <div className="flex items-center space-x-6">
                            <span className="text-sm font-400 capitalize ">
