  ...
  return (
    <>
      ...
      <div className="quick-view-grid w-full lg:flex justify-between lg:space-x-2 xl:space-x-0 items-center mt-3 ">
        <div className="qv-item xl:w-[252px] xl:h-[208px] lg:w-1/2 w-full mb-5 xl:mb-0 bg-qblack group hover:bg-qgreen transition-all duration-300 ease-in-out p-6 rounded">
