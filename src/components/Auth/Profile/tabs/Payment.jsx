        ...
        <ul className="items">
          <li className="sm:flex justify-between items-center w-full py-[30px] border-b border-light-purple">
            ...
            <div>
              <button
                type="button"
                className="w-[116px] sm:h-[46px] h-[40px]  bg-qred text-qblack font-medium sm:text-18 text-sm tracking-wide"
              >
                <span>Manage</span>
              </button>
            </div>
          ...
          <li className="sm:flex justify-between items-center w-full py-[30px] border-b border-light-purple">
            <div className="flex space-x-5 items-center mb-3 sm:mb-0">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p className="sm:text-18 text-sm tracking-wide text-red-500">
                  Verified
                </p>
              </div>
            </div>
