                    ...
                    <div className="signin-area mb-3.5">
                      <div className="flex justify-center">
                        <button
                          ...
                          className="bg-qgreen rounded disabled:bg-opacity-60 disabled:cursor-not-allowed  mb-6 text-sm text-white w-full h-[50px] font-semibold flex justify-center bg-purple items-center"
                        >
