                ...
                <div className="input-area">
                  ...
                  <div className="forgot-password-area flex justify-between items-center mb-7">
                    ...
                    <Link href="/forgot-password">
                      <span className="text-base text-qred cursor-pointer">
                  ...
                  <div className="signin-area mb-3.5">
                    <div className="flex justify-center">
                      <button
                        onClick={doLogin}
                        type="button"
                        className="bg-qred rounded mb-6 text-sm text-white w-full h-[50px] font-semibold flex justify-center bg-purple items-center"
                      >
