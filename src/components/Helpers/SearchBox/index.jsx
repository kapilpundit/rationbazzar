  ...
  return (
    <>
      <div className="relative w-full h-full">
        <div
          className={`w-full h-full flex items-center   border border-qgray-border rounded overflow-hidden  ${className || ""
            }`}
        >
          ...
          <button style={{ background: "#DE4839" }}
                ...
                {categories &&
                  categories.map((item, i) => (
                    <li onClick={() => categoryHandler(item)} key={i}>
                      <span className="text-qgray text-sm font-400 border-b border-transparent hover:border-qred hover:text-qred cursor-pointer">
                        {item.name}
                      </span>
                    </li>
                  ))}
