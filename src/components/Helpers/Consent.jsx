          ...
          <div className="w-full h-full flex flex-col justify-between relative">
            ...
            <div className="flex space-x-4 items-center h-[42px]">
              <button
                ...
                type="button"
                className="w-1/2 h-full rounded text-base font-bold bg-qred text-white antialiased tracking-wide"
              >
              ...
              <button
                ...
                type="button"
                className="w-1/2 h-full rounded text-base font-bold bg-qgreenlow text-qred antialiased tracking-wide"
              >
