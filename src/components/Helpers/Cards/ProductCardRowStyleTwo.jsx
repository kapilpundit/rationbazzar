...
const Redirect = () => {
  return (
    <div className="flex space-x-2 items-center">
      <span className="text-sm text-red-500">Item added</span>
      <Link href="/cart">
        <span className="text-xs border-b border-blue-600 text-red-600 mr-2 cursor-pointer">
          Go To Cart
        </span>
      </Link>
    </div>
          ...
          <div className="flex-1 h-full flex flex-col justify-center">
            ...
            >
              <a rel="noopener noreferrer">
                <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-red-600 cursor-pointer">
                  {datas.title}
                </p>
              </a>
            </Link>
