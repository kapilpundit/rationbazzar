        ...
        <div>
          ...
          >
            <a rel="noopener noreferrer">
              <p className="title mb-2.5 text-[20px] font-600 text-center text-qblack leading-[24px] line-clamp-2 hover:text-[#DE4839]-600 cursor-pointer">
                {datas.title}
              </p>
            </a>
          </Link>
            ...
            <div className="price">
              {offerPrice && (
                <span
                  ...
                  className="offer-price text-center text-[#DE4839] font-600 text-[18px] mr-1 inline-block"
                >
